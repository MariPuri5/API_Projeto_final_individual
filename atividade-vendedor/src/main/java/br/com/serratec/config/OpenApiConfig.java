...
public class OpenApiConfig {
	...
	public OpenAPI myOpenApi() {
		...
		contact.setEmail("GRUPO3@mail.com");
		contact.setUrl("https://www.serratec.com.br");
		
		//3)
		License apacheLicense = new License().name("Apache").
				url("https://opensource.org/licenses/Apache-2.0");
		Info info = new Info().title("API DO LANÇAMENTO DE VENDAS").version("1.0").contact(contact)
				.description("API DA ATIVIDADE VENDA - GRUPO 3").termsOfService("https://www.serratec.com.br")
